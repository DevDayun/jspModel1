...
public class BbsDto implements Serializable {
	...
	private int seq;		// sequence 글번호(고유한 글번호)
	private String id;		// 작성자 - 외부에서 들어와야 하는 데이터
	
	private int ref;		// 답글용	그룹번호(글번호)
	private int step;		//		행번호
	private int depth;		//		깊이
	
	private String title;	// 제목	- 외부에서 들어와야 하는 데이터
	private String content;	// 글내용	- 외부에서 들어와야 하는 데이터
